  ...
  const plans = [
    {
      ...
      features: {
        ...
        chapterTests: 'No Chapter Tests',
        formulas: 'No Formulas & Flashcards',
        mockTests: 'No Mock Tests',
    ...
    },
    {
      ...
      features: {
        questions: '200 Questions per day',
        chapterTests: '10 Chapter Tests per day',
        formulas: 'No Formulas & Flashcards',
        mockTests: 'No Mock Tests',
        analytics: 'No Detailed Analytics',
      },
    ...
    },
    {
      ...
      features: {
        questions: '5000 Questions per day (Almost Unlimited)',
        chapterTests: '50 Chapter Tests per day',
        formulas: 'Unlimited Formulas & Flashcards',
        mockTests: '8 Mock Tests per day',
